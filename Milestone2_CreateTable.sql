...
LINES TERMINATED BY '\r\n'
IGNORE 1 LINES
(@col1,@col2,@col3,@col4,@col5,@col6,@col7,@col8,@col9,@col10,@col11,@col12) set firstName=@col2,lastName=@col3,gender=@col4,age=@col5,weight=@col6,height=@col7,phoneNumber=@col8,password=@col9,email=@col10,address=@col11,hikingLevel=@col12;
