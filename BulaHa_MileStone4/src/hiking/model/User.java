...
public class User {
	...
	public User(int userId, String firstName, String lastName, String password, int age, double weight, double height,
	...
	public User(String firstName, String lastName, String password, int age, double weight, double height,
			String address, String email, String phoneNumber, Gender gender, HikingLevel hikingLevel) {
		this.firstName = firstName;
		this.lastName = lastName;
		this.password = password;
